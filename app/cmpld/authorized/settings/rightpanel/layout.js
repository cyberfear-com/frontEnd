						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement('input', { type: 'radio', name: 'inlineRadioOptions', checked: this.state.firstRadio,
										onChange: this.handleClick.bind(this, 'firstRadio') }),
									React.createElement('img', { src: '/img/layouts/3col.jpg', className: 'layimage img-thumbnail img-responsive row-centered' })
								),
								React.createElement(
									'label',
									{ className: 'col-xs-6 col-sm-4' },
									React.createElement('input', { type: 'radio', name: 'inlineRadioOptions', checked: this.state.secondRadio,
										onChange: this.handleClick.bind(this, 'secondRadio') }),
									React.createElement('img', { src: '/img/layouts/2col2hor.jpg', className: 'layimage img-thumbnail img-responsive row-centered' })
								),
								React.createElement(
									'label',
									{ className: 'col-xs-6 col-sm-4' },
									React.createElement('input', { type: 'radio', name: 'inlineRadioOptions', checked: this.state.thirdRadio,
										onChange: this.handleClick.bind(this, 'thirdRadio') }),
									React.createElement('img', { src: '/img/layouts/2col.jpg', className: 'layimage img-thumbnail img-responsive row-centered' })
								)
							),
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										...
										React.createElement(
											'button',
											{ type: 'button', className: 'btn btn-default', onClick: this.handleClick.bind(this, 'resetLayout') },
											'Cancel'
										)
									)
								)

				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement('input', { type: 'password', name: 'fpass', className: 'form-control', id: 'newPass', placeholder: 'new password',
								...
								React.createElement(
									'div',
									{ className: 'form-group' },
									React.createElement('input', { type: 'password', name: 'fpassrep', className: 'form-control', id: 'newPassRep', placeholder: 'repeat password',
							...
							React.createElement(
								'div',
								{ className: 'pull-left dialog_buttons' },
								React.createElement(
									'button',
									{ type: 'button', className: this.state.button3Class, onClick: this.handleClick.bind(this, 'enableSecondPass') },
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: "alert alert-warning " + this.state.secAlertText, role: 'alert' },
							...
							React.createElement(
								...
								React.createElement(
									'div',
									{ className: 'form-group' },
									React.createElement('input', { type: 'password', name: 'spass', className: 'form-control', id: 'newSecret', placeholder: 'new secret phrase',
								...
								React.createElement(
									'div',
									{ className: 'form-group' },
									React.createElement('input', { type: 'password', name: 'spassrep', className: 'form-control', id: 'newSecretRep', placeholder: 'repeat secret phrase',
							...
							React.createElement(
								'button',
								{ type: 'button', className: "col-xs-12 col-sm-6 " + this.state.button2Class, onClick: this.handleClick.bind(this, 'disableSecondPass') },
							...
							React.createElement(
								'div',
								{ className: 'col-xs-12 col-sm-6 pull-right text-right dialog_buttons' },
								React.createElement(
									'button',
									{ type: 'button', className: 'btn btn-primary',

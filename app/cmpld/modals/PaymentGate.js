    ...
    return React.createClass({
        ...
        checkEmail: function () {
            ...
            $.ajax({
                ...
                url: "api/checkEmailExistV2",
                data: {
                    email: this.state.email + '@CyberFear.com'
        ...
        render: function () {
            return React.createElement(
                'div',
                { className: 'modal fade bs-example-modal-sm', id: 'createAccount-modal', tabIndex: '-1', role: 'dialog',
                    'aria-hidden': 'true' },
                React.createElement(
                    'div',
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'a',
                                    { className: '', href: 'https://twitter.com/intent/tweet/?text=I\'m protecting my emails with SCRYPTmail.&url=https://cyberfear.com', target: '_blank', 'aria-label': '' },

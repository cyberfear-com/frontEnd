define(["app", "forge", 'openpgp'], function (app, forge, openpgp) {
    ...
    var unregFunctions = Backbone.Model.extend({
        ...
        reply: function (action) {
            ...
            var preReplyText = '<br/><br/><br/><br/>--------------------------------------------<br/><br/>' + 'On ' + new Date(currentMessage['meta']['timeSent'] * 1000).toDateString(options) + ' at ' + new Date(currentMessage['meta']['timeSent'] * 1000).toLocaleTimeString() + ', ' + fromMail['htmlFdisplay'] + ' wrote: <br/>';

        ...
        render: function () {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: "btn-group m-r-sm pull-right unregIcons " + (this.state.navPage == 'readEmail' ? "" : "hidden") },
                        React.createElement(
                            'button',
                            { className: "btn btn-sm btn-default w-xxs w-auto-xs " + (this.state.canReply ? "" : "hidden"), 'data-placement': 'bottom', 'data-toggle': 'popover-hover', title: '', 'data-content': 'Reply to Sender', onClick: this.handleClick.bind(this, 'reply') },
                            React.createElement('i', { className: 'fa fa-reply fa-lg' })
                        ),
                        React.createElement(
                            'button',
                            { className: 'btn btn-sm btn-default w-xxs w-auto-xs', 'data-placement': 'bottom', 'data-toggle': 'popover-hover', title: '', 'data-content': 'Toggle View', onClick: this.handleClick.bind(this, 'togglePlainHTML') },
                            React.createElement(
                                'span',
                                { className: this.state.isHtml ? "bold" : "" },
                                'HTML'
                            ),
                            ' / ',
                            React.createElement(
                        ...
                        React.createElement(
                            'button',
                            { className: 'btn btn-sm btn-default w-xxs w-auto-xs', 'data-placement': 'bottom', 'data-toggle': 'popover-hover', title: '', 'data-content': 'Delete', onClick: this.handleClick.bind(this, 'deleteEmail') },
                            React.createElement('i', { className: 'fa fa-trash-o fa-lg' })
                        )
                    ),
                    React.createElement(
                        'div',
                        { className: "btn-group m-r-sm pull-right unregIcons " + (this.state.navPage == 'composeEmail' ? "" : "hidden") },
                        React.createElement(
                            'button',
                            { id: 'sendingMailUnreg', className: 'btn btn-primary btn-sm', onClick: this.handleClick.bind(this, 'sendEmail') },
                            'Send'
                        ),
                        React.createElement(
                            'button',
                            { className: 'btn btn-danger btn-sm', onClick: this.handleClick.bind(this, 'cancelCompose') },
                            'Cancel'
                        )
                    )
                )

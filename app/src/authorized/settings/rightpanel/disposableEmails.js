				...
				<div className="col-lg-5 col-xs-12 personal-info ">
					<div className="panel panel-default">
						...
						<div className="panel-body">
							...
							<p>
								<b>Email Aliases</b> - this is an alternate addresses that can be used to receive email at your CyberFear account. Email aliases are not alternative login addresses. Using email aliases makes it possible to give out an email addresses that can't be targeted for login attacks.
							</p>
                            <p>

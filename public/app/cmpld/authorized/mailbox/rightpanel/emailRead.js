define(["react", "app"], function (React, app) {
    return React.createClass({
        ...
        componentDidMount: function () {
            ...
            $("#virtualization").contents().find("html").append("<style>table,table tbody,table tr,table td{display:block;width:100%;}</style>");
        },
                ...
                labels.push(React.createElement(
                    ...
                    React.createElement(
                        "a",
                        {
                            ...
                            value: index,
                            className: thisComp.state.tag === app.transform.from64str(index) ? "active" : ""
                        },
                        React.createElement(
                            "span",
                            { className: "icon" },
        ...
        handleChange: function (i, event) {
            switch (i) {
                ...
                case "assignLabel":
                    ...
                    if (this.state.tag === app.transform.from64str($(event.target).attr("value"))) {
                    ...
                    if (app.user.get("currentMessageView")["id"] !== undefined && app.user.get("currentMessageView")["id"] !== "") {
                        ...
                        var updatePinToTop = setTimeout(function () {
                            if (parseInt(pinnedTop) < 0) {
                                messages[emailId]["pt"] = email["meta"]["timeSent"];
                                thisComp.setState({
                                    pinTop: 0
                                });
                            } else {
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                {
                                    className: `d-decrypting-message ${app.user.get("isDecryptingEmail") ? "d-flex" : "d-none"}`
                                },
                                React.createElement(
                                    "div",
                                    null,
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                this.state.tag !== `` ? React.createElement(
                                    "div",
                                    { className: "email-labels" },
                                    React.createElement(
                                        "span",
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement(
                                                    ...
                                                    React.createElement("path", {
                                                        d: "M13.5119 9.2475L12.5969 8.3325C12.3794 8.145 12.2519 7.8675 12.2444 7.56C12.2294 7.2225 12.3644 6.885 12.6119 6.6375L13.5119 5.7375C14.2919 4.9575 14.5844 4.2075 14.3369 3.615C14.0969 3.03 13.3544 2.7075 12.2594 2.7075H4.42187V2.0625C4.42187 1.755 4.16687 1.5 3.85937 1.5C3.55187 1.5 3.29688 1.755 3.29688 2.0625V15.9375C3.29688 16.245 3.55187 16.5 3.85937 16.5C4.16687 16.5 4.42187 16.245 4.42187 15.9375V12.2775H12.2594C13.3394 12.2775 14.0669 11.9475 14.3144 11.355C14.5619 10.7625 14.2769 10.02 13.5119 9.2475Z",
                                                        fill: this.getTagColor(this.state.tag)
                                                    })
                                                )
                                            ),
                                            this.state.tag
                                        ...
                                        React.createElement(
                                            "a",
                                            {
                                                onClick: this.handleChange.bind(this, "removeTag"),
                                                title: "Remove Tag"
                                            },
                                            React.createElement(
                                                "svg",
                                ...
                                React.createElement(
                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement("path", { d: "M18 38 4 24l14-14 2.1 2.1L9.7 22.5H44v3H9.7l10.4 10.4Z" })
                                        )
                                    ),
                                    React.createElement(
                                        "div",
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                {
                                                    type: "button",
                                                    className: `btn btn-secondary btn-pin-to-top ${this.state.pinTop === -1 ? "active" : "normal"}`,
                                                    onClick: this.handleClick.bind(this, "pinToTop")
                                                },
                                                React.createElement(
                                                    "span",
                                                    { className: "icon normal" },
                                                    this.state.pinTop === -1 ? React.createElement(
                                                        "svg",
                                                        {
                                                            width: "28",
                                                            height: "27",
                                                ...
                                                React.createElement(
                                                    "span",
                                                    { className: "text" },
                                                    this.state.pinTop === -1 ? `Pinned` : `Pin to top`
                                                )
                                            ),
                                            React.createElement(
                                                "div",
                                                { className: "dropdown dropdown-labels-wrapper" },
                                                React.createElement(
                                                    "button",
                                                    {
                                                    ...
                                                    React.createElement(
                                                        ...
                                                        React.createElement(
                                                            ...
                                                            React.createElement("path", {
                                                                d: "M13.5119 9.2475L12.5969 8.3325C12.3794 8.145 12.2519 7.8675 12.2444 7.56C12.2294 7.2225 12.3644 6.885 12.6119 6.6375L13.5119 5.7375C14.2919 4.9575 14.5844 4.2075 14.3369 3.615C14.0969 3.03 13.3544 2.7075 12.2594 2.7075H4.42187V2.0625C4.42187 1.755 4.16687 1.5 3.85937 1.5C3.55187 1.5 3.29688 1.755 3.29688 2.0625V15.9375C3.29688 16.245 3.55187 16.5 3.85937 16.5C4.16687 16.5 4.42187 16.245 4.42187 15.9375V12.2775H12.2594C13.3394 12.2775 14.0669 11.9475 14.3144 11.355C14.5619 10.7625 14.2769 10.02 13.5119 9.2475Z",
                                                                fill: this.state.tag !== `` ? this.getTagColor(this.state.tag) : `#C9D0DA`
                                                            })
                                                        )
                                                    )
                                                ),
                                                ...
                                                React.createElement(
                                                    ...
                                                    React.createElement(
                                                        ...
                                                        React.createElement(
                                                            ...
                                                            this.state.pinTop === -1 ? `Un-pin from top` : `Pin to top`
                                                        )
                                                    ),
                                                    React.createElement(
                                                        "li",
                                                        { className: "dropdown-labels-wrapper dropdown-labels-mobile" },
                                                        React.createElement(
                                                            "ul",
                                                            {

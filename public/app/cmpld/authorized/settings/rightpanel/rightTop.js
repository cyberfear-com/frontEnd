define(["react", "app", "cmpld/authorized/mailbox/notifications"], function (React, app, Notifications) {
    "use strict";
        ...
        render: function () {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "div",
                        { className: "dropdown icon-notification" },
                        React.createElement(
                            "button",
                            {
                                ...
                                onClick: this.handleClick.bind(this, "open-notifications")
                            },
                            React.createElement(
                                "svg",
                                {
                ...
                this.state.notificationFlag && React.createElement(Notifications, null)
            );
        }
    });
});
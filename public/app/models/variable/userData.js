    ...
    var UserData = Backbone.Model.extend({
        ...
        assignUservariables: function (callback) {
            ...
            var filter = JSON.parse(
                JSON.stringify(this.get("DecryptedBlackListObject")[0]["data"])
            );

            this.set({ filter: filter });

            this.set({
                contacts: this.get("DecryptedContactsObject")[0]["data"],
            });
        ...
        assignVariablesFromUserObject: function () {
            ...
            $.each(
                app.user.get("DecryptedUserObject")[0]["data"]["keys"],
                function (email64, emailData) {
        ...
        assignVariablesFromFolderObject: function () {
            ...
            var folders = jQuery.extend(
                true,
                {},
                this.get("DecryptedFolderObject")[0]["data"]
            );
        ...
        createTestData: function () {
            ...
            if (testEnv) {
                ...
                allKeys["c2VyZ0BzY3J5cHRtYWlsLmNvbQ=="] = {
                    ...
                    privateKey:
                        "",
                    publicKey:
                        "",
                    receiveHash: "08e4641886",
                    signature: "aGpqampqampqampqamo=",
                };

                allKeys[
                    "dXJ4bzU0ZzBoYm11dzVndnBkMHIzZHYxaDN2QHNjcnlwdG1haWwuY29t"
                ] = {
                    addrType: 2,
                    canSend: false,
                    date: 1437155609,
        ...
        assignVariablesFromProfileObject: function () {
            ...
            this.set({
                displayName: app.transform.from64str(
                    this.get("DecryptedProfileObject")[0]["data"]["displayName"]
                ),
            });
            if (
                this.get("DecryptedProfileObject")[0]["data"]["email"] ==
                undefined
            ) {
            ...
            this.set({
                defaultPGPKeybit: parseInt(
                    this.get("DecryptedProfileObject")[0]["data"][
                        "defaultPGPKeybit"
                    ]
                ),
            });
            ...
            this.set({
                mailPerPage: this.get("DecryptedProfileObject")[0]["data"][
                    "mailPerPage"
                ],
            });
            this.set({
                sessionExpiration: this.get("DecryptedProfileObject")[0][
                    "data"
                ]["sessionExpiration"],
            });
            ...
            this.set({ timeLeft: "" });
            this.set({
                remeberPassword: this.get("DecryptedProfileObject")[0]["data"][
                    "remeberPassword"
                ],
            });
            ...
            this.set({
                Factor2: {
                    type: this.get("DecryptedProfileObject")[0]["data"][
                        "Factor2"
                    ]["type"],
                    secret: app.transform.from64str(
                        this.get("DecryptedProfileObject")[0]["data"][
                            "Factor2"
                        ]["secret"]
                    ),
                    since: this.get("DecryptedProfileObject")[0]["data"][
                        "Factor2"
                    ]["since"],
                },
            });
...
*/
            ...
            this.set({
                showDisplayName: this.get("DecryptedProfileObject")[0]["data"][
                    "showDisplayName"
                ],
            });

            this.set({
                enableForwarding: this.get("DecryptedProfileObject")[0]["data"][
                    "enableForwarding"
                ],
            });
            this.set({
                forwardingAddress: app.transform.from64str(
                    this.get("DecryptedProfileObject")[0]["data"][
                        "forwardingAddress"
                    ]
                ),
            ...
            this.set({
                notificationSound: app.transform.from64str(
                    this.get("DecryptedProfileObject")[0]["data"][
                        "notificationSound"
                    ]
                ),
            ...
            this.set({
                enableNotification: this.get("DecryptedProfileObject")[0][
                    "data"
                ]["enableNotification"],
            });
            this.set({
                notificationAddress: app.transform.from64str(
                    this.get("DecryptedProfileObject")[0]["data"][
                        "notificationAddress"
                    ]
                ),
            ...
            this.set({
                inboxLayout: app.transform.from64str(
                    this.get("DecryptedProfileObject")[0]["data"]["inboxLayout"]
                ),
            });
            ...
            if (
                ...
                this.set({
                    rememberContacts: this.get("DecryptedProfileObject")[0][
                        "data"
                    ]["rememberContacts"],
                });
            }
            ...
            this.set({
                customDomains: this.get("DecryptedProfileObject")[0]["data"][
                    "customDomains"
                ],
            });

define(["react", "app"], function (React, app) {
    return React.createClass({
        render: function () {
            return (
                <div className={`app-notification type-1 active`}>
                    <div className="_inside">
                        <div>
                            <div className="_header d-flex justify-content-between">
                                <div>
                                    <h5 className="_title">{`Notifications`}</h5>
                                </div>
                                <div>
                                    <button
                                        type="button"
                            ...
                            <div className="_content">
                                ...
                                <div>
                                    <div className="_enable_notification">
                                        <p>
                                            <span className="_icon">
                                                <svg
                                                    width="22"
                                ...
                                <div className="_items_wrapper">
                                    <div className="_items">
                                        <div className="_item">
                                            <div className="_c_inner">
                                                <div className="_icon _system">
                                                    <svg
                                                        width="24"
                                                        height="24"
                                                        viewBox="0 0 24 24"
                                                ...
                                                <div className="_details">
                                                    <h6 className="_title">{`Your password has been successfully changed.`}</h6>
                                                    <p className="_desc">
                                        ...
                                        <div className="_item">
                                            <div className="_c_inner">
                                                <div className="_icon _w_initial _w_star">
                                                    <span className="_initials">
                                                        SG
                                                    </span>
                                                    <span className="_starred">
                                                        <svg
                                                            width="12"
                                                            height="12"
                                                            viewBox="0 0 12 12"
                                                ...
                                                <div className="_details">
                                                    <h6 className="_title">
                                                        {`Jhosef Jones`}{" "}
                                                        <span class="_ins">{`Assigned you on the call with Ada and Sarra.`}</span>
                                                    </h6>
                                                    <ul className="_meta">
                                                        <li>{`23 mins ago`}</li>
                                                        <li>{`3 attachments`}</li>
                                                    </ul>
                                                    <ul className="_attachments _type_files">
                                                        <li>
                                                            <span className="_icon">
                                                                <svg
                                                                    width="20"
                                        ...
                                        <div className="_item">
                                            <div className="_c_inner">
                                                ...
                                                <div className="_details">
                                                    ...
                                                    <ul className="_meta">
                                                        <li>{`2 hours ago`}</li>
                                                        <li>{`15 attachments`}</li>
                                                    </ul>
                                                    <ul className="_attachments _type_images">
                                                        <li>
                                                            <img

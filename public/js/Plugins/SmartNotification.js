...
$.SmartMessageBox = function (settings, callback) {
    ...
    if (settings.input != undefined) {
        ...
        switch (settings.input) {
            case "text":
                settings.inputValue =
                    $.type(settings.inputValue) === "string"
            ...
            case "select":
                if (settings.options == undefined) {
                    alert(
                        "For this type of input, the options parameter is required."
                    );
                } else {
                    InputType =
                        "<select class='form-control' id='txt" +
                        SmartMSGboxCount +
                        "'>";
    ...
    Content +=
        "<span class='MsgTitle'>" + settings.title + "</span class='MsgTitle'>";
        ...
        if (isIE8orlower() == 0) {
            ...
            if (navigator.userAgent.match("Firefox/"))
                audioElement.setAttribute(
                    "src",
                    $.sound_path + settings.sound_file + ".ogg"
                );
            else
                audioElement.setAttribute(
                    "src",
                    $.sound_path + settings.sound_file + ".mp3"
                );

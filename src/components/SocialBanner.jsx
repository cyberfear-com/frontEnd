    ...
    <div className={classNames(styles.banner, "bg-light rounded-5 p-3 p-md-5")}>
      <div className="m-4">
        ...
        <h4 className="d-none d-md-block">
          Reach Us on Your Favorite{" "}
          <span className="text-primary">Social Media Platform</span>
        </h4>
        ...
        {links.map((link) => (
          ...
          >
            ...
            <small className="flex-grow-1 ms-3 lh-sm">
              <div
                className={classNames(styles.followUs, "text-body-secondary")}
              >
                Follow Us on {link.title}
              </div>
              <div className={classNames(styles.username, "text-body mt-1")}>

    ...
    return (
        <>
            ...
            <CardBanner
                ...
                containerClassName={classNames(styles.bannerWrapper, (isActive || isSearchActive()) && styles.active)}
            >
                ...
                <div 
                    ref={suggestionsRef}
                    className={classNames(styles.search, 'mx-auto', (isActive || isSearchActive()) && styles.active)}
                >
                    <input 
                        type="text" 
                        class="form-control bg-primary text-bg-primary" 
                    ...
                    <CrossIconSVG className={styles.reset} role='button' onClick={() => {
                        setQuery('')
                    }} /> 
                    ...
                    <div className={classNames(
                        ...
                        {searchResults.length > 0 ?
                            ...
                            {searchResults.map((question, index) => (
                                <li 
                                    key={question.id} 
                                    className={classNames('small py-3', index > 0 && 'border-top')}
                                    role='button'
                                    onClick={() => {
                                ...
                                >
                                    <p className='text-truncate m-0'>
                                        ...
                                        <span className='content ms-2'>{question.question}</span>
                                    </p>
                                </li>
                            ))}
                            </ul> :
                            <p className='small opacity-50 my-3'>
                                No results.
                            </p>
                        }
                        </div>

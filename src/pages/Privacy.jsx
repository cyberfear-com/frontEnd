...
export default function Privacy() {
    return <>
        ...
        <div className='container my-5'>
            ...
            <p>When you register for an Account, we may ask for you to choose a username and a password.</p>
            <p>We store the day of user's last login for the purpose of account deletion when it is past due date.</p>
            ...
            <p>The right to access - You have the right to request copies of your personal data. Keep in mind that except for your hashed username and the day of last login, we do not have any more data to provide.</p>
